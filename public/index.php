...
<div class="wrapper">
	...
	<div class="right-section">
		<img alt="Sandhoora Holdings" src="images/logo.svg"/>
		...
		<ul class="info">
			<li><i class="fa fa-phone-square"></i>+94-114-321-930 - Nimesha</li>
			<li><i class="fa fa-map-marker"></i>Sandhoora Holdings (PVT) Ltd. , 424 1/1 , Kotte road, Pitakotte, Kotte.</li>
			<li><i class="fa fa-envelope"></i><a href="#">info@sandhooraholdings.lk</a></li>
		</ul>
